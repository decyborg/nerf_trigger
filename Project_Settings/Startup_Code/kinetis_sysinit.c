...
void (* const InterruptVector[])() __attribute__ ((section(".vectortable"))) = {
    ...
    TPM0_IRQHandler, /* FTM0 fault, overflow and channels interrupt */
    TPM1_IRQHandler, /* FTM1 fault, overflow and channels interrupt */
    TPM2_IRQHandler, /* FTM2 fault, overflow and channels interrupt */
